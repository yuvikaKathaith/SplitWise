      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-md">
            ...
            <button className="bg-[#ff7a30] hover:bg-[#ff9d69] text-white font-medium py-2 px-4 rounded-full text-sm">
              Start chat →
            </button>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md">
        ...
        <div className="bg-white rounded-lg mt-12 py-4 px-6 shadow text-sm text-gray-600">
